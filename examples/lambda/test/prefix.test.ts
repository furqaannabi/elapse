...
/**
 * FR-EXM-159: this example runs at `/` locally and at a path prefix in production
 * (examples.elapse.finance/lambda/). A root-absolute URL in the browser escapes the prefix: the page at
 * /lambda/ asking for "/web.js" gets the other example's bundle, or nothing.
 */
...
describe("FR-EXM-159 every URL the browser requests is relative", () => {
