...
describe("FR-LND-014 hero for both readers", () => {
  ...
  it("FR_LND_014_offers_one_button_per_reader", () => {
    ...
    // FR-LND-014 amended a third time 2026-09-26: straight to Northwind, a page that exists, so the
    // homepage never waits on the examples' root page being deployed.
    expect(screen.getByRole("link", { name: /see the demo/i })).toHaveAttribute("href", "https://examples.elapse.finance/lambda/");
  });
