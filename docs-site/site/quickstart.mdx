...
import ExampleReactComponents from '/snippets/example-react-components.mdx';
...
<Steps>
  ...
  <Step title="Render the meter, then authorise on your phone">
    ...
    The docked capsule, hiding controls, and the proof drop are on the [React page](/react).
  </Step>
</Steps>
