...
Status: **FR-LND-014 amended a third time (`See the demo` → Northwind, live) Signed 2026-09-26 (Furqaan)** · **FR-LND-014 amended again (`See the demo` → Acme GPU, live) Signed 2026-09-26 (Furqaan)** · **FR-LND-014 amendment (`See the demo` → the live examples) Signed 2026-09-26 (Furqaan)** · **Built · FR-LND-014–019 signed and built 2026-09-08** · Surface: Persuade · Sources: design brief Surface 1; detailed doc §1, §5.3, §16.
...
| FR-LND-014 | **Hero for both readers.** Headline stays `You only pay what elapsed.` The subline speaks for the merchant: earns per second of use, paid out in dollars as it accrues, integrated like Stripe (SDK, hosted checkout, signed webhooks). Buttons: primary `Start integrating` → docs quickstart; secondary `See the demo` → scrolls to the merchant section (FR-LND-016) until the video exists, then the video. **Amended 2026-09-26 (signed, Furqaan):** `See the demo` → `https://examples.elapse.finance/`, the page linking both live examples (examples FRD FR-EXM-037), instead of scrolling to the merchant section. The video, when it exists, sits beside the examples rather than replacing them. **Amended again 2026-09-26 (signed, Furqaan):** `See the demo` → `https://examples.elapse.finance/saas/`, Acme GPU, the live example the Quickstart is built from, in place of the examples' root page. It links straight to a page that exists, so the homepage never depends on the root page being deployed. **Amended a third time 2026-09-26 (signed, Furqaan):** `See the demo` → `https://examples.elapse.finance/lambda/`, Northwind — real code on AWS Lambda, billed by the second — in place of Acme GPU. | Built 2026-09-26 |
...
| 2026-09-26 | Claude (for Furqaan) | **FR-LND-014 amended again:** the examples' root page was never deployed, so the button links straight to `/saas/`, which is live, rather than wait on the box. |
| 2026-09-26 | Furqaan | **Signed** the second FR-LND-014 amendment. |
| 2026-09-26 | Claude (for Furqaan) | **FR-LND-014 amended a third time:** the button opens Northwind rather than Acme GPU. |
| 2026-09-26 | Furqaan | **Signed** the third FR-LND-014 amendment. |
