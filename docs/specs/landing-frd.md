...
Status: **FR-LND-014 amended again (`See the demo` → Acme GPU, live) Signed 2026-09-26 (Furqaan)** · **FR-LND-014 amendment (`See the demo` → the live examples) Signed 2026-09-26 (Furqaan)** · **Built · FR-LND-014–019 signed and built 2026-09-08** · Surface: Persuade · Sources: design brief Surface 1; detailed doc §1, §5.3, §16.
