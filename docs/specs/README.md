...
| `examples-lambda-frd.md` | **Signed** · per-second serverless-compute example on real AWS Lambda; auto-lifecycle (first-Run start, heartbeat/idle/beacon/cap end); runner infra live 2026-09-12; build in progress · merchant-start amendments FR-EXM-102/114/115/125/126/133 **awaiting sign-off 2026-09-15** | Furqaan, 2026-09-12 |
