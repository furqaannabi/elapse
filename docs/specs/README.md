...
| `sdk-frd.md` | **Signed** · `@elapse/sdk@0.1.0` on npm; **Python frozen out of the submission 2026-09-07** (FR-SDK-041) · FR-SDK-005 `manage_url` amendment **signed and built 2026-09-09**  · FR-SDK-009 `subscriptions.start` — **frozen-surface change signed 2026-09-14** · FR-SDK-042 (0.1.4, `Product.start_mode`) **signed 2026-09-16 (Furqaan)** · FR-SDK-043 (0.2.0, no `url`) **awaiting sign-off 2026-09-17** | William, 2026-09-05 |
| `react-sdk-frd.md` | **Draft — awaiting sign-off 2026-09-17** · `@elapse/react` replaces the hosted checkout; every signature in the Elapse popup | — |
...
| `docs-site-frd.md` | **Signed** · built 2026-09-06 (`docs-site/`, snippet sync, surface check, CI workflow); Mintlify hosting connect and hosted API URL pending · FR-DOC-022 manage section **signed and built 2026-09-09** · FR-DOC-047 React page **awaiting sign-off 2026-09-17** | William, 2026-09-06 |
| `examples-frd.md` | **Signed** · built and proven 2026-09-06, including the FR-EXM-031 CI job · FR-EXM-032 `@elapse/react` **awaiting sign-off 2026-09-17** | William, 2026-09-06 |
| `examples-lambda-frd.md` | **Signed** · per-second serverless-compute example on real AWS Lambda; auto-lifecycle (first-Run start, heartbeat/idle/beacon/cap end); runner infra live 2026-09-12; build in progress · merchant-start amendments FR-EXM-102/114/115/125/126/133 **signed 2026-09-16 (Furqaan)** · FR-EXM-152 `@elapse/react` **awaiting sign-off 2026-09-17** | Furqaan, 2026-09-12 |
